...
describe('@0ctx/cli build artifact source', () => {
    it('includes expected command verbs in CLI source', () => {
        ...
        expect(source).toContain("0ctx setup [--clients=ga|preview|all|claude,cursor,windsurf,codex,antigravity] [--no-open] [--json] [--validate]");
        ...
        expect(source).toContain("0ctx mcp setup [--clients=ga|preview|all|claude,cursor,windsurf,codex,antigravity] [--mcp-profile=all|core|recall|ops] [--no-open]");
        expect(source).toContain("0ctx install [--clients=ga|preview|all|claude,cursor,windsurf,codex,antigravity] [--json] [--skip-bootstrap] [--mcp-profile=all|core|recall|ops]");
        ...
        expect(source).toContain("0ctx connector hook install [--clients=ga|preview|all|claude,cursor,windsurf,codex,factory,antigravity] [--repo-root=<path>] [--global]");
        expect(source).toContain("preview Preview-only integrations");
