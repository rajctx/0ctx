...
describe('@0ctx/cli build artifact source', () => {
    it('includes expected command verbs in CLI source', () => {
        ...
        expect(source).toContain("0ctx connector hook install [--clients=all|claude,cursor,windsurf,codex,factory,antigravity] [--repo-root=<path>] [--global]");
