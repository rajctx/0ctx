...
describe('@0ctx/cli build artifact source', () => {
    it('includes expected command verbs in CLI source', () => {
        ...
        expect(cliSurface).toContain("0ctx install [--clients=ga|claude,factory,antigravity] [--json] [--skip-bootstrap] [--mcp-profile=all|core|recall|ops] [--allow-preview]");
        ...
        expect(cliSurface).toContain("0ctx connector hook install [--clients=ga|claude,factory,antigravity] [--repo-root=<path>] [--global] [--allow-preview]");
        expect(cliSurface).toContain("Preview integrations: codex, cursor, windsurf (name them explicitly only when you opt in).");
