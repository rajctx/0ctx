...
- Hosted UI BFF migration is complete — all local daemon/CLI coupling removed; UI communicates exclusively through BFF route handlers via control-plane HTTP bridge.
